"""
Teste manual escalonado v3: coleta os 4 jogos mais recentes do Brasil
e persiste end-to-end (collector -> transformer -> persister).

Diferença da v2: ao invés de processar apenas 2 partidas,
iteramos sobre os 4 jogos mais recentes, salvando para cada um:

  [uma vez, antes do loop]
  1. dim_selecao         (Brasil)
  2. fato_power_ranking_selecao (Brasil, round atual)

  [para cada uma das 4 partidas]
...
Observações:
  - performance_points é coletado uma vez para o Brasil e reutilizado
    nas 4 partidas (o dict retornado cobre todos os match_ids do time).
...
Rodar localmente:
    cd backend
    python3 test_pipeline_basicov3.py
"""
...
if __name__ == "__main__":
    with httpx.Client() as client:
        ...
        # ── Buscar os 4 jogos mais recentes ───────────────────────────────────
