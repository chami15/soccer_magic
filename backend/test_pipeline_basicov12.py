"""
Teste manual escalonado v12: coleta os 5 jogos mais recentes de cada uma das
6 seleções que jogam hoje, já nas oitavas de final (mata-mata), persistindo
tudo end-to-end.

Mesma função processar_time() das versões v4–v11. Como são 6 times de uma
vez (3 partidas), cada time é processado dentro de um try/except isolado,
seguindo o mesmo padrão de robustez introduzido na v11.
...
Rodar localmente:
    cd backend
    python3 test_pipeline_basicov12.py
"""
...
TIMES_BUSCA = [
    ...
    (("Japan", "Japão", "Japao"), "Japão"),
    (("Germany", "Alemanha"), "Alemanha"),
    (("Paraguay", "Paraguai"), "Paraguai"),
    (("Netherlands", "Holanda", "Países Baixos", "Paises Baixos"), "Holanda"),
    (("Morocco", "Marrocos"), "Marrocos"),
]
...
if __name__ == "__main__":
    ...
    with httpx.Client() as client:
        ...
        # ── Localizar os 6 times nos dados da Copa ───────────────────────────────
        print(f"\n{'=' * 60}")
        print("=== Localizando os 6 times dos jogos de hoje (oitavas) ===")
        print("=" * 60)
