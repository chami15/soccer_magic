...
from agents.tools import enrich_context, get_match_incidents, get_match_statistics, get_team_recent_matches
...
INSTRUCTIONS = [
    ...
    "Os campos statistics e incidents de cada MatchCollected devem ser exatamente o retorno dessas tools — nunca resuma, estime ou invente valores.",
...
def build_agent(sofascore_client: httpx.Client) -> Agent:
    return Agent(
        ...
        tools=[get_team_recent_matches, get_match_statistics, get_match_incidents, enrich_context],
